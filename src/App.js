    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-black-90 backdrop-blur-md py-4' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
          <div className="flex text-2xl font-bold tracking-wider items-center space-x-4">
            <img src="empower-group_dark-bg.png" alt="logo" width="30" height="40"></img>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="text-3xl font-bold mb-4 flex items-center space-x-4">
                <img src="empower-group_dark-bg.png" alt="logo" width="30" height="40"></img>
      ...
      <WhatsAppChat
        ...
        companyName="First Class Travel" // Replace with your company name
      />
    </>
    </div>
  );
